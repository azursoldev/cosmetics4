		                	...
		                	<div class="card">
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-md-12">
									        <div class="form-group">
										        <label class="control-label">{{ _lang('Product URL') }}</label>
										        <input type="text" class="form-control" name="slug" value="{{ $product->slug }}" placeholder="product-url-slug" minlength="3" maxlength="255">
										        <small class="form-text text-muted">{{ _lang('Leave blank to auto-generate from product name. Minimum 3 characters.') }}</small>
									        </div>
									    </div>
